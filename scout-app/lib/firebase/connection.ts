...
const firebaseSetupSteps: ISetupGuideStep[] = [
  {
    number: 1,
    ...
    images: [
      ...
      {
        src: "/firebase-vercel-env-7a9a8bd7-6e7a-46ee-84dc-4ffbe85895e9.png",
        instruction:
          "Locate your database environment variables. These are typically prefixed `FIREBASE`.",
      },
    ],
  },
  {
...
export const firebaseConnection: IConnection = {
  id: "firebase",
  name: "Firebase",
  status: "not-connected",
  setupSteps: firebaseSetupSteps,
};
